...
4. **Prefer cheap verification** — For normal verification, prefer fixer/Kimi or deterministic local checks. Oracle/GPT is expensive and should be used only as one short final gate when explicitly needed or requested.
