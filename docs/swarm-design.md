...
3. **No auto-cascade of oracle review after blockers** — Do not automatically spawn oracle or model review follow-ups after a blocker resolves. Ask the user or give a checkpoint first, unless they explicitly told you to fully auto-run and accepted the cost.
