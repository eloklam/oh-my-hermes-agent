...
6. **Cost-control and checkpointing** — checkpoint early, keep updates concise, and never block in long foreground polling loops. Oracle/deep-review remains valid for explicit requests and high-risk gates; cost control only prevents silent repeated expensive cascades. See [docs/swarm-design.md](docs/swarm-design.md) for the full rules.
